...
## Flickr 8k VQA and Image Captioning Model

In addition to the PathVQA model, this repository also includes a VQA model trained on the Flickr 8k dataset. This model is designed to handle a variety of visual questions related to general images and also trained for image captioning task.
..
### Model Details
